...
Regardless of the source of GTFS, `assess_gtfs` expects feeds to be compressed
zip archives.

`assess_gtfs` was written to prepare GTFS feeds for a comparison of British &
